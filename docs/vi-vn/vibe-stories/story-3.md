---
title: Tôi đã làm một "bạn học xuất sắc không bao giờ mệt" cho mỗi học sinh
description: Câu chuyện về một giáo viên tin học trung học phổ thông tạo ra "cộng tác viên lập trình" bằng AI.
---
...
![Giao diện chính của Trung tâm Khóa học Tin học](./images/story-3/image2.png)
...
![Giao diện kiểm tra code của Cộng tác viên lập trình](./images/story-3/image3.png)
...
![Minh họa chứng chỉ hoàn thành khóa học](./images/story-3/image5.png)
